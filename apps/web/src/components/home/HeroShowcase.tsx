...
import { useHeroIntroOnce } from '../../hooks/useHeroIntroOnce';
...
export default function HeroShowcase({ dramas }: HeroShowcaseProps) {
  ...
  return (
    <section
      className={`hero-showcase relative min-h-[620px] overflow-hidden rounded-[28px] border border-white/[0.08] bg-panel shadow-card md:min-h-[720px] lg:min-h-[100svh] lg:rounded-none lg:border-0 lg:shadow-none ${
    ...
    >
      ...
      <div className="relative z-10 mx-auto flex min-h-[620px] w-full max-w-[1440px] flex-col justify-between px-5 pb-7 pt-8 sm:px-8 md:min-h-[720px] md:px-10 md:py-12 lg:min-h-[100svh] lg:px-16 lg:pb-16 lg:pt-28 xl:px-20">
        <div className="pt-4 md:pt-10 lg:mt-auto lg:pb-32">
          <HeroInfoPanel
            drama={selectedDrama}
      ...
      <div className="hero-scroll-cue pointer-events-none relative z-10 -mt-7 flex animate-float items-center justify-center pb-5 text-xs font-medium lg:absolute lg:bottom-4 lg:left-1/2 lg:-translate-x-1/2 lg:pb-0">
